...
export default function EditPostPage() {
  ...
  if (loading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#0F0608]">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="mt-1 font-display text-xl font-bold text-white">Edit post</h1>
          </div>
          ...
          <div className="space-y-4">
            <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-5">
              ...
              <div className="mb-4 flex items-center gap-2">
                ...
                >
                  <span className={`h-1.5 w-1.5 rounded-full ${published ? 'bg-emerald-400' : 'bg-white/30'}`} />
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="mb-1.5 block text-xs font-medium text-white/50">Cover image URL</label>
                  <input
                    value={coverImage}
                ...
                <div>
                  <label className="mb-1.5 block text-xs font-medium text-white/50">Tags (comma-separated)</label>
                  <input
                    value={tags}
            ...
            <div className="flex flex-col gap-2">
              ...
              {published && (
                <Link
                  href={`/blog/${slug}`}
                  target="_blank"
                  className="block w-full rounded-xl border border-white/[0.06] py-2.5 text-center text-sm text-white/40 transition hover:text-white/70"
                >
                  View live →
                </Link>
              )}
